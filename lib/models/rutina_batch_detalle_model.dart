// lib/models/rutina_batch_detalle_model.dart

import 'package:flutter/material.dart';

/// Modelo extendido de RutinaBatch que incluye información de la rutina
class RutinaBatchDetalle {
  final int id;
  ...
  final String? rutinaNombre; // Campo extra del JOIN
  ...
  factory RutinaBatchDetalle.fromMap(Map<String, dynamic> map) {
